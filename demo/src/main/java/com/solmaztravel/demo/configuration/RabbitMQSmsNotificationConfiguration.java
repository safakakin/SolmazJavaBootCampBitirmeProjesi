...
@Configuration
public class RabbitMQSmsNotificationConfiguration {
    private String queueName = "com.solmaztravel.notification.sms";

    private String exchange = "com.solmaztravel.notification.sms";
